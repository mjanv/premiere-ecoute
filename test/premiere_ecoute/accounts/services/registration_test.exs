defmodule PremiereEcoute.Accounts.Services.RegistrationTest do
  ...
  describe "register_twitch_user/1" do
    test "create a new user" do
      data = twitch_data()
      {:ok, user} = Registration.register_twitch_user(data)
    ...
    test "find an existing user" do
      data = twitch_data()
      {:ok, _} = Registration.register_twitch_user(data)
