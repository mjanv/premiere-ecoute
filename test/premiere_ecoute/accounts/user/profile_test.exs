defmodule PremiereEcoute.Accounts.User.ProfileTest do
  ...
  describe "create/1" do
    ...
    test "can create an user with an user profile" do
      {:ok, user} = User.create(%{email: "user@email.com", profile: %{color_scheme: :light, language: :it}})
  ...
  describe "update/1" do
    test "can update an user with an user profile" do
      ...
      {:ok, user} = User.update(user, %{email: "user2@email.com", profile: %{color_scheme: :dark, language: :en}})
