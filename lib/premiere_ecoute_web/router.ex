defmodule PremiereEcouteWeb.Router do
  ...
  scope "/wantlist", PremiereEcouteWeb.Wantlist do
    ...
    live_session :wantlist, on_mount: [{UserAuth, :viewer}] do
      live "/", WantlistLive, :index
    end
  end
  ...
  scope "/collections", PremiereEcouteWeb.Collections do
    ...
    live_session :collections_overlay, on_mount: [{UserAuth, :current_scope}] do
      live "/overlay/:username", CollectionOverlayLive, :show
    end
    ...
    live_session :collections, on_mount: [{UserAuth, :streamer}] do
      ...
      live "/:id", CollectionSessionLive, :show
    end
  end
  ...
  scope "/discography", PremiereEcouteWeb.Discography do
    ...
    live_session :discography_pages, on_mount: [{UserAuth, :current_scope}] do
      ...
      live "/singles/:slug", SingleLive, :show
      live "/artists", ArtistsLive, :index
