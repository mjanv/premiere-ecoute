defmodule PremiereEcoute.Adapters.TwitchAdapter do
  @moduledoc """
  Twitch API adapter that implements the StreamingPlatformPort.
  Handles Twitch OAuth, polls, and chat integration.
  """

  @behaviour PremiereEcoute.Core.Ports.StreamingPlatformPort
