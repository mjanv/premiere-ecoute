...
# Boruta acts as the OAuth 2.1 authorization server fronting the MCP endpoint
  ...
  plugins: [
    ...
    {Oban.Plugins.Cron,
     crontab: [
       ...
       # {"0 2 * * *", PremiereEcoute.Radio.Workers.SyncRadioDiscographyWorker},
...
config :esbuild,
  ...
  premiere_ecoute: [
    args:
      ~w(js/app.js js/storybook.js js/pcm-processor.js --bundle --target=es2022 --outdir=../priv/static/assets/js --external:/fonts/* --external:/images/*),
