...
config :esbuild,
  ...
  premiere_ecoute: [
    args:
      ~w(js/app.js js/storybook.js js/pcm-processor.js js/explore.js --bundle --target=es2022 --outdir=../priv/static/assets/js --external:/fonts/* --external:/images/* --jsx=automatic),
